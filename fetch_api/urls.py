...
urlpatterns = [
    ...
    path('usuarios/genero/<str:gender>/', views.get_users_by_gender,
         name='usuarios_por_genero'),
    path('usuarios/idade/<int:age>/', views.get_users_by_age,
         name='usuarios_por_idade'),
